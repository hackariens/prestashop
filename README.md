# Welcome to @hackariens/prestashop 👋
...
![Continuous Integration](https://github.com/hackariens/prestashop/workflows/ci/badge.svg?branch=develop)
...
```sh
git clone --recurse-submodules git@github.com:hackariens/prestashop.git prestashop
cd prestashop
```
